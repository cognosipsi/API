...
aplicacion.get('/usuarios', (req:any, res:any) => {
    // query -> es un metodo para acceder a las consultas de la base de datos
    connection.query("select * from usuarios", (requirement:any,response:any)=>
    {
...
aplicacion.get('/usuarios/:id', (req:any, res:any) => {
...
aplicacion.post('/crearUsuarios',(req:any, res:any) => {
    // nombre,correo,donacion,apellido es el id del formulario (campo) "formControlName='nombre'"
        ...
        connection.query("INSERT INTO `usuarios` (nombre,apellido,correo,donacion) VALUES ('"+nombre+"','"+apellido+"','"+correo+"','"+donacion+"')" ,(req1:any,res1:any)=>{
...
//1ra forma (el id se pasó a través del url)
aplicacion.put('/modificarUsuarios/:id',(req:any, res:any) => {
